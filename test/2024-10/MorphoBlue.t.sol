...
interface IMorphoBundler {
    ...
    function approve2(IAllowanceTransfer.PermitSingle memory permitSingle, bytes memory signature, bool skipRevert)
        external
        payable;
    ...
    function morphoWithdrawCollateral(MarketParams memory marketParams, uint256 assets, address receiver)
        external
        payable;
