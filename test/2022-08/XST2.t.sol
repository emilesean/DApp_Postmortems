...
contract ContractTest is Test {
    ...
    IUniswapV2Pair Pair1 =
        IUniswapV2Pair(0x0d4a11d5EEaaC28EC3F61d100daF4d40471f1852); // WETH USDT
    IUniswapV2Pair Pair2 =
        IUniswapV2Pair(0x694f8F9E0ec188f528d6354fdd0e47DcA79B6f2C); // WETH XST
    uint256 amount;
    ...
    function uniswapV2Call(
        ...
        uint256 amountOutXST = (amountSellWETH * 997 * reserve0) /
            (reserve1 * 1000 + amountSellWETH * 997);
        ...
        uint256 amountOutWETH = (amountSellXST * 997 * reserve4) /
            (reserve3 * 1000 + amountSellXST * 997);
