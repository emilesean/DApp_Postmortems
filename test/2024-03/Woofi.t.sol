...
contract ContractTest is Test {
    IERC20 public constant WOO =
        IERC20(0xcAFcD85D8ca7Ad1e1C6F82F651fA15E33AEfD07b);
    IERC20 public constant USDCe =
        IERC20(0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8);
    IERC20 public constant WETH =
        IERC20(0x82aF49447D8a07e3bd95BD0d56f35241523fBab1);

    address public constant WooPPV2 =
        address(0xeFF23B4bE1091b53205E35f3AfCD9C7182bf3062);
    address public constant Silo =
        address(0x5C2B80214c1961dB06f69DD4128BcfFc6423d44F);
    address public constant Univ3pool =
        address(0xC31E54c7a869B9FcBEcc14363CF510d1c41fa443); //usdce/weth pool

    address public constant LBT =
        address(0xB87495219C432fc85161e4283DfF131692A528BD); // woo/weth

    address public constant WooracleV2 =
        address(0x73504eaCB100c7576146618DC306c97454CB3620);
