...
import {IUniswapV2Router as IRouter} from "src/interfaces/IUniswapV2Router.sol";
...
contract crb2 is Test {
    ...
    function setUp() public {
        ...
        router = IRouter(payable(0x10ED43C718714eb63d5aA57B78B54704E256024E));
        ...
        flashLoan = IUniswapV3Pair(0x46Cf1cF8c69595804ba91dFdd8d6b960c9B0a7C4);
